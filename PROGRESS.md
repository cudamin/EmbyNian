...
- **发布**：[Release v0.0.1](https://github.com/cudamin/EmbyNian/releases/tag/v0.0.1)，tag 由 API 打在远端 master 当时指向的 `12f498fa`。安装包没有签名，SmartScreen 会拦一次（Release 说明里写了「仍要运行」）。
