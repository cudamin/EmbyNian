...
/// </para>
/// </summary>
public sealed class EpisodeMenuRequestGate
{
    /// <summary>
    ...
    public EpisodeMenuRequestGate(TimeSpan? interval = null) => _interval = interval ?? DefaultInterval;
